...
- Jams
  ...
  - A jam will happen if someone signs up as space-holder 
  - Jams are silent by default unless the space-holder decides otherwise
  - Jams can happen anytime the studio is open given that a space holder is present
